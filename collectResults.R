...
Row <- 1
load(file.path("#enter desired file location",paste("MyResult", "Row", Row,".Rdata" , sep ="")))
K <- nrow(MyResult)
...
for (i in 1:TotalCells){
  Row <- i
  load(file.path("#enter desired file location",paste0("MyResult", "Row", Row,".Rdata" , sep ="")))
