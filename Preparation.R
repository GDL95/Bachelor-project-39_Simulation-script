...
## Results hole simulation studie 
...
##Single row for conformation the script yields a normal mcnemar p-value (takes 13 minutes to run on my laptop)
#Design <- Design[c(376),]

##Extremely unqual asymmetric  
#Design <- Design[c(289, 292, 296, 299:301, 304, 308, 311:313, 316, 320, 323:325, 328, 332, 335:337, 340, 344, 347:349, 352, 356, 359:361, 364, 368, 371:373, 376, 380, 383:384),]
